package com.example.caesaryu.lab5;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  void showListDialog(){
        ...
        AlertDialog.Builder diolog_list= new AlertDialog.Builder(MainActivity.this);
        diolog_list.setTitle("請使用List呈現");
        diolog_list.setItems(list_item, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
